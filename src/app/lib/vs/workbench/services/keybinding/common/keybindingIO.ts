...
import { Keybinding, SimpleKeybinding, ChordKeybinding, KeyCodeUtils } from './keyCodes';
...
export class KeybindingIO {
    ...
    public static readKeybinding(input: string): Keybinding {
        if (!input) {
            return null;
        }

        const [firstPart, remains] = this._readSimpleKeybinding(input);
    ...
    static _readUserBinding(input: string): [SimpleKeybinding | ScanCodeBinding, SimpleKeybinding | ScanCodeBinding] {
        ...
        const [firstPart, remains] = this._readSimpleUserBinding(input);
